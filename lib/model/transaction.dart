...
class TransactionModel{
  ...
  String? description_after_user;
  String? description_before_owner;
  ...
  TransactionModel(
      ...
      this.description_after_user,
      this.description_before_owner,
  ...
  static TransactionModel fromDocument(String id, Map<String, dynamic> json) {
    return TransactionModel(
        ...
        description_after_user : json['description_after_user'],
        description_before_owner : json['description_before_owner'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "description_after_user" : description_after_user,
        "description_before_owner" : description_before_owner,
